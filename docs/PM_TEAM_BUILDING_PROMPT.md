...
>
> **Status:** Phase 0–6 implementation code exists in `src/`, `tests/`, and `web/`. `PLANNING_HYGIENE.md` is **superseded**. The prompts below are retained as historical reference for the Phase 0 conveyor belt.
